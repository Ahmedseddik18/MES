...
$semaine = $_POST['semaine'];
        ...
        header("Location: archive.php?commande=$commande&article=$article&phase=$phase&categorie=$categorie&tissu=$tissu&dateChargement=$dateChargement&semaine=$semaine");
