...
$selectFields = 'commande, article, phase, categorie, traitement, relaxation, tissu, quantitedemandee, nbpartie, nbsub, prixunitaire,prixtotal';
$fromTables = 'db';
...
$params = [
    'id' => $id
        ...
        if ($alertClass === 'alert-success') {
            ...
            header("Location: pilotage-archive-prix.php");
