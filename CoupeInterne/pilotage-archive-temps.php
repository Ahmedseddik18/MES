...
$semaine = $_POST['semaine'];
        ...
        header("Location: archive-temps.php?commande=$commande&article=$article&phase=$phase&categorie=$categorie&tissu=$tissu&dateChargement=$dateChargement&semaine=$semaine");
...
>
  <head>
    ...
    <title>Coupe Interne | Archive Des Temps Standards</title>
