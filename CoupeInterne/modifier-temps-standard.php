...
$commande = isset($_GET['commande']) ? htmlspecialchars(trim($_GET['commande'])) : null;
$article = isset($_GET['article']) ? htmlspecialchars(trim($_GET['article'])) : null;
$sub = isset($_GET['sub']) ? htmlspecialchars(trim($_GET['sub'])) : null;
$TSR = $_GET['tsr'];
$TSM = $_GET['tsm'];
$TSC = $_GET['tsc'];
$TSE = $_GET['tse'];
...
// Define conditions without backticks for PostgreSQL
...
$result = updateData('commande', $data, $conditions, $params, $conn);
    ...
    if ($alertClass === 'alert-success') {
        ...
        header('Location: pilotage-archive-temps.php');
        exit;
    }
...
>
  <head>
    ...
    <title>Coupe Interne | Modifier Temps Standard</title>
