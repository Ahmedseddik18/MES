...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($nom) || empty($prenom) || empty($username) || empty($password) || empty($role)) {
        ...
        $table = 'users';
        $data = 'nom, prenom, username, password, role';
                    ...
                    <div class="card-body">
                      <form  method="POST"  enctype="multipart/form-data">
                        <div class="row">
                          ...
                          <div class="mb-3 col-md-6">
                            ...
                            <select id="role" name = "role" class="select2 form-select">
                              ...
                              <option value="responsable-utm">Responsable UTM</option>
                              <option value="responsable-coupe">Responsable Coupe</option>
                        ...
                        <div class="mt-2 text-end">
                          <button type="submit" name "Suivant" class="btn btn-primary me-2">Enregistrer</button>
