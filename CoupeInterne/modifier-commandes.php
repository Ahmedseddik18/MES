...
include("../php/fonction.php");
        ...
        $selectFields = 'id,commande, article, etat, datechargement';
        $fromTables = "db";
		
			$whereConditions = " prixunitaire is null or prixunitaire = '0.00' ";
        ...
        if ($result && $result->rowCount() > 0) {
            ...
            while ($row = $result->fetch(PDO::FETCH_ASSOC)) {
                ...
                echo "<a href='ajouter-prix-unitaire.php?id=" . htmlspecialchars($row['id']) . "'><i class='bx bxs-pencil'></i></a>"; // Icône d'édition
                echo "</td>";	
