...
if (isset($_POST['Suivant'])) {
    ...
    if (empty($message)) {
        $table = 'db';
        $conditions = "commande = '{$formData['commande']}' AND article = '{$formData['article']}'";
        ...
        if ($existingCount > 0) {
            ...
            if ($uploadResult['status'] === 'success') {
                ...
                $data = 'commande, article, phase, categorie, traitement, relaxation, tissu, quantiteDemandee, nbPartie, dateChargement, nbSub, semaine, Etat, fichier, subvalues';
                $values = "'{$formData['commande']}', '{$formData['article']}', '{$formData['phase']}', '{$formData['categorie']}', '{$formData['traitement']}', '{$formData['relaxation']}', '{$formData['tissu']}', '{$formData['quantite']}', '{$formData['nbPartie']}', '{$formData['dateChargement']}', '{$formData['nbSub']}', '{$formData['semaine']}', '$etat', '$uploadedFilesStr', '{$formData['subValues']}'";
