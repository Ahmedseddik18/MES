...
>
  <head>
    ...
    <title>Coupe Interne | Liste Des Matériels</title>
...
<?php include 'navbar.php'; ?>
          ...
          <div class="content-wrapper">
            ...
            <div class="flex-grow-1 container-p-y container-fluid">
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Ressources /</span> Matériels</h4>
                ...
                <table class="table table-hover">
                    <thead class="text-dark fs-4">
                        <tr>
                            ...
                            <th class="border-bottom-0">
                                <h6 class="fw-semibold mb-0">Longeur</h6>
                            </th>
...
if ($result) {            // Utilisation de fetch() pour récupérer les résultats avec PDO
            while ($row = $result->fetch(PDO::FETCH_ASSOC)) {
                echo "<tr>";
				echo "<td class='border-bottom-0'>" . htmlspecialchars($row['ref']) . "</td>";
                echo "<td class='border-bottom-0'>" . htmlspecialchars($row['longueur']) . "</td>";
                echo "<td class='border-bottom-0'>" . strtoupper(htmlspecialchars($row['largeur'])) . "</td>";


                
				if ($_SESSION['role'] == 'admin'){
                echo "<td class='border-bottom-0'>";
                echo "<a href='modifier-materiel.php?id=" . htmlspecialchars($row['id']) . "'><i class='bx bxs-pencil'></i></a>"; // Icône d'édition
				echo "  ";
                echo "<a href='supprimer-materiel.php?id=" . htmlspecialchars($row['id']) . "'><i class='bx bxs-trash'></i></a>"; // Icône d'édition
                echo "</td>";
				}
                echo "</tr>";
            }
        ...
        ?>
					...
					<div class="mt-2 text-end">
                          <button type="submit" name "Suivant" class="btn btn-primary me-2" onclick="window.location.href='ajouter-materiel.php';">Ajouter</button>
