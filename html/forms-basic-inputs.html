...
$query = "INSERT INTO testcommande (commande, article, couleur) VALUES ('$commande', '$article', '$couleur')";
              ...
              <div class="row">
				...
				<form method="POST" action="" enctype="multipart/form-data">
                  <div class="card mb-4">
                    ...
                    <div class="card-body">
                      <div>
                        <label for="defaultFormControlInput" class="form-label">Commande</label>
                        <input
                          type="text"
                          class="form-control"
